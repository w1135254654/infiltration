        ...
        function () {
                ...
                return o.m = n,
                    ...
                    o.t = function (t, e) {
                        ...
                        if (o.r(n), Object.defineProperty(n, "default", {
                            enumerable: !0,
                            value: t
                        }), 2 & e && "string" != typeof t) for (var r in t) o.d(n, r,
                            function (e) {
                                return t[e]
                            }.bind(null, r));
                        return n
            ...
            function (e, t, n) {
                ...
                t.addWrapper = function (e, t) {
                    ...
                    t.cleanUp = function (t) {
                        t.showModal && r.
                            default.close();
                        t.onLoadingEnd && t.onLoadingEnd(); (t.showModal || t.onLoadingStart) && window.URL.revokeObjectURL(t.printable);
                        if (t.onPrintDialogClose) {
                            var n = "mouseover"; (o.
                                default.isChrome() || o.
                                    default.isFirefox()) && (n = "focus");
                ...
                function f(e, t) {
                    ...
                    return Object.keys(o).map(function (e) {
                        (- 1 !== t.targetStyles.indexOf("*") || -1 !== t.targetStyle.indexOf(o[e]) ||
                            function (e, t) {
            ...
            function (e, t, n) {
                ...
                var a = {
                    show: function (e) {
                        ...
                        o.setAttribute("class", "printSpinner"),
                            n.appendChild(o);
                        ...
                        switch (void 0 === e ? "undefined" : i(e)) {
                            ...
                            case "object":
                                for (var n in t.printable = e.printable,
                                    ...
                                    t.fallbackPrintable = void 0 !== e.fallbackPrintable ? e.fallbackPrintable : t.printable, t.fallbackPrintable = t.base64 ? "data:application/pdf;base64," + t.fallbackPrintable : t.fallbackPrintable, t) "printable" !== n && "fallbackPrintable" !== n && "base64" !== n && (t[n] = void 0 !== e[n] ? e[n] : t[n]);
                                break;
                            default:
                            ...
                            case "pdf":
                                if (a.
                                    default.isFirefox() || a.
                                        default.isEdge() || a.
                                            default.isIE()) try {
                                                if (console.info("PrintJS currently doesn't support PDF printing in Firefox, Internet Explorer and Edge."), !0 === t.onBrowserIncompatible()) window.open(t.fallbackPrintable, "_blank").focus(),
            ...
            function (e, t, n) {
                ...
                t.
                    ...
                    print: function (e, t) {
                        if (e.base64) {
                            var n = Uint8Array.from(atob(e.printable),
                                function (e) {
                            ...
                            r.responseType = "arraybuffer",
                                r.addEventListener("load",
                                    function () {
                                        if (- 1 === [200, 201].indexOf(r.status)) return (0, a.cleanUp)(e),
                ...
                t.
                    ...
                    print: function (e, t) {
                        ...
                        n ? (e.printableElement = function e(t, n) {
                            ...
                            return r
                        }(n, e), e.header && (0, o.addHeader)(e.printableElement, e), a.
                            default.send(e, t)) : window.console.error("Invalid HTML element id: " + e.printable)
                    }
                }
            },
            function (e, t, n) {
                    ...
                    print: function (r, e) {
                        r.printable.constructor !== Array && (r.printable = [r.printable]),
                            ...
                            r.printable.forEach(function (e) {
                                ...
                                t.setAttribute("style", r.imageStyle),
                                    t.src = e;
                                var n = document.createElement("div");
                                n.appendChild(t),
                                    r.printableElement.appendChild(n)
                            }),
