!function (t, e) {
    ...
    (0, function () {
        ...
        var e = Element.prototype, r = e.matches || e.webkitMatchesSelector || e.mozMatchesSelector || e.msMatchesSelector || e.oMatchesSelector,
            u = function (t, e) {
                if (!t || 1 !== t.nodeType) {
                    return !1;
                }
        ...
        !function (t, e) {
            ...
            if (t && "undefined" != typeof document) {
                ...
                a.type = "text/css", "top" === n && i.firstChild ? i.insertBefore(a, i.firstChild) : i.appendChild(a),
        ...
        var o = function (t, e) {
            ...
            s = function (t) {
                return {
                    previousText: "PREVIOUS", nextText: "NEXT", crossChapter: !1, crossChapterText: !1, routerMode: t.routerMode || d.HASH
                }
            },
            ...
            return l(n, [
                {
                    ...
                    value: function () {
                        ...
                        {
                            name: this.hyperlink.innerText, href : this.hyperlink.getAttribute("href"), chapterName : this.chapter && this.chapter.innerText || ""
                        }
                    }
                }]), n
        }();
        var x =
        {
            ...
            inner: function (t, e) {
                ...
                t.prev && e.crossChapterText && '<div class="pagination-item-subtitle">' + t.prev.chapterName + "</div>",
                ...
                t.next && e.crossChapterText && '<div class="pagination-item-subtitle">' + t.next.chapterName + "</div>",
                t.next && "</a>\n        </div>\n      "].filter(Boolean).join("")
            }
        };
        window.$docsify = window.$docsify || {}, window.$docsify.plugins = [function (t, e) {
            ...
            function i() {
                ...
                t && (t.innerHTML = x.inner(function (t, e) {
                    ...
                    try {
                        var a = i === d.HISTORY ? t.route.path : "#" + t.route.path, r = g(p.all(".sidebar-nav li a")).filter(function (t) {
                        ...
                        return {
                            prev: new y(s[c - 1]).toJSON(), next: new y(s[c + 1]).toJSON()
                        }
                    }
                    catch (t) {
                        return {}
